...
import io.github.vooft.spektor.test.TestFiles.listBookByAuthorsFile
...
class SpektorCodegenTest {
    ...
    fun test() {
        ...
        val schema = parser.parse(listOf(listFile, listBookByAuthorsFile, pathVarFile, requestBodyFile))
